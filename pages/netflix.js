      ...
      <div className="w-full">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <button className="px-8 py-2 mt-4 mr-8"><a target="_blank" href="https://netflix-clone-ede02.web.app/">Demo</a></button>
            <button className="px-8 py-2 mt-4"><a target="_blank" href="https://github.com/Rotich2000/netflix-clone">Code</a></button>
          </div>
